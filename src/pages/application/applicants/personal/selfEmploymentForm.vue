  ...
  <BasePage :title="`${currentEmploymentItem?.statusCode} - ${currentEmploymentItem?.typeStatus}`" hasBack>
    <wd-form :model="formData" ref="formRef" class="flex-col gap-4">
      ...
      <FormItem label="Basis">
        <wd-picker :columns="basisColumns" v-model="formData.basis" placeholder="Select basis" />
      </FormItem>
      <FormItem label="Occupation">
        <wd-input type="text" v-model="formData.occupation" placeholder="Enter occupation" />
      </FormItem>
      ...
      <FormItem label="Employer">
        <wd-input type="text" v-model="formData.employerId" placeholder="Enter position title" />
      </FormItem>
      <FormItem label="Business Start Date">
        <wd-datetime-picker type="date" v-model="formData.businessStartDate" placeholder="Select business start date" />
      </FormItem>
      <FormItem label="Business Activity">
        <wd-input type="text" v-model="formData.businessActivity" placeholder="Enter business activity" />
      </FormItem>
      <FormItem label="Industry">
        <wd-input type="text" v-model="formData.industry" placeholder="Enter industry" />
      </FormItem>
      <FormItem label="Industry Code">
        <wd-input type="text" v-model="formData.industryCode" placeholder="Enter industry code" />
      </FormItem>
      <FormItem label="Number of Employees">
        <wd-input-number v-model="formData.numberOfEmployees" placeholder="Enter number of employees" />
      </FormItem>
      <FormItem label="Number of Locations">
        <wd-input-number v-model="formData.numberOfLocations" placeholder="Enter number of locations" />
      </FormItem>
      <FormItem label="Is Franchise">
        <wd-switch v-model="formData.isFranchise" size="medium" />
      </FormItem>
      <FormItem label="Own Premises">
        <wd-switch v-model="formData.ownPremises" size="medium" />
      </FormItem>
      <view
      ...
      >
        <FormItem label="Start Date">
          <wd-datetime-picker type="date" v-model="income.startDate" placeholder="Select start date" />
        </FormItem>
        <FormItem label="End Date">
          <wd-datetime-picker type="date" v-model="income.endDate" placeholder="Select end date" />
        </FormItem>
